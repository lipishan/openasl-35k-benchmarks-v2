...
class TrainLoop:
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        if args.dataset in ['kit', 'humanml', 'openasl'] and args.eval_during_training:
            ...
            self.eval_gt_data = get_dataset_loader(name='openaslgt', batch_size=args.eval_batch_size, num_frames=None,
                                                   split=args.eval_split,
